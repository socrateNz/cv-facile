      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="relative bg-gradient-to-r from-pink-500 to-purple-600 px-8 py-12 text-white">
          <div className="relative z-10">
            <h1 className="text-5xl font-bold mb-2">{cv.fullName || "Nom complet"}</h1>
            <p className="text-xl opacity-90">{cv.title || "Titre professionnel"}</p>
        ...
        <div className="p-8">
          {cv.summary && (
            <div className="mb-8 p-6 bg-gray-50 rounded-lg">
              <p className="text-gray-700 italic leading-relaxed">{cv.summary}</p>
            </div>
          )}
